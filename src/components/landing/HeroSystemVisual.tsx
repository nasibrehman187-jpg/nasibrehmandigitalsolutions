...
export function HeroSystemVisual() {
  return (
    <div
      className="relative w-full max-w-xl mx-auto rounded-2xl border border-[#1E3A63] bg-[#0E1E36] p-3 sm:p-5 shadow-2xl shadow-[#10233F]/80 text-white overflow-hidden"
      aria-hidden="true"
    >
      ...
      <div className="flex items-center justify-between border-b border-[#1E3A63] pb-3 text-xs text-[#8A9EB5]">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-2 hidden sm:inline-block font-mono text-[11px] text-[#A0B3C6]">
      ...
      <div className="pt-4 space-y-3 sm:space-y-3.5">
        ...
        <div className="rounded-xl border border-[#1E3A63] bg-[#142642] p-3.5 sm:p-4 transition hover:border-[#087F8C]/60">
          <div className="flex items-center justify-between pb-2 border-b border-[#1E3A63]/60">
            <div className="flex items-center gap-2">
              <span className="grid h-6 w-6 place-items-center rounded-md bg-[#087F8C] text-white">
            ...
            <span className="rounded bg-[#087F8C]/20 text-[#2DD4BF] border border-[#087F8C]/40 px-2 py-0.5 text-xs font-mono">
              From $99
            </span>
          </div>
          <div className="mt-2.5 flex items-center justify-between text-xs text-[#D1DCE8]">
            <span>Services Catalog • Contact Form • Fast Handover</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="rounded-xl border border-[#1E3A63] bg-[#142642] p-3.5 transition hover:border-[#087F8C]/60">
            <div className="flex items-center justify-between pb-2 border-b border-[#1E3A63]/60">
              <div className="flex items-center gap-2">
                <span className="grid h-6 w-6 place-items-center rounded-md bg-teal-600/80 text-white">
                  <Bot className="h-3.5 w-3.5" />
                </span>
                <span className="text-xs sm:text-sm font-semibold text-white">AI Chatbot</span>
              </div>
              <span className="text-xs font-mono text-[#2DD4BF]">Chatbot example</span>
            </div>
          ...
          <div className="rounded-xl border border-[#1E3A63] bg-[#142642] p-3.5 transition hover:border-[#087F8C]/60">
            <div className="flex items-center justify-between pb-2 border-b border-[#1E3A63]/60">
              <div className="flex items-center gap-2">
                <span className="grid h-6 w-6 place-items-center rounded-md bg-sky-600/80 text-white">
                  <Mic className="h-3.5 w-3.5" />
                </span>
                <span className="text-xs sm:text-sm font-semibold text-white">Voice Agent</span>
              </div>
              <span className="text-xs font-mono text-sky-300">Voice example</span>
            </div>
            <div className="mt-2 p-2.5 rounded-md bg-[#10233F] border border-[#1E3A63] space-y-1.5">
              <div className="flex items-center justify-between text-xs text-[#D1DCE8]">
                <span>Call Routing & Booking</span>
              </div>
        ...
        <div className="rounded-xl border border-[#1E3A63] bg-[#142642] p-3.5 sm:p-4 transition hover:border-[#087F8C]/60">
          <div className="flex items-center justify-between pb-2 border-b border-[#1E3A63]/60">
            <div className="flex items-center gap-2">
              <span className="grid h-6 w-6 place-items-center rounded-md bg-emerald-600/80 text-white">
            ...
            <span className="text-xs font-mono text-emerald-300">Automation example</span>
          </div>
          ...
          <div className="mt-3 flex items-center justify-between gap-1.5 sm:gap-2 text-xs overflow-x-auto">
            ...
            <ArrowRight className="h-3.5 w-3.5 text-[#087F8C] shrink-0" />
            <div className="rounded bg-[#087F8C]/30 border border-[#087F8C] px-2.5 py-1 text-[#2DD4BF] font-medium shrink-0">
              WhatsApp Alert
            </div>
          </div>
        </div>
