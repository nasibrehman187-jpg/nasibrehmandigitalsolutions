      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 lg:gap-12 px-6 lg:grid-cols-12">
        <div className="lg:col-span-6 xl:col-span-6">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            <Link
              to="/contact"
              className="group inline-flex min-h-12 items-center justify-center gap-2 rounded-lg bg-[#087F8C] px-6 py-3 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-[#066670] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#087F8C]"
            >
            ...
            <Link
              to="/services"
              className="group inline-flex min-h-12 items-center justify-center gap-2 rounded-lg border border-[#2A4365] bg-transparent px-6 py-3 text-sm font-semibold text-[#D1DCE8] transition-all duration-200 hover:bg-white/5 hover:border-[#3B5B88] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#087F8C]"
            >
              Explore Services
          ...
          <div className="mt-10 pt-6 border-t border-[#1E3A63] grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs text-[#8A9EB5]">
