        ...
        <div className="mt-10 space-y-8 text-sm text-[#5B6472] leading-relaxed">
          ...
          <section className="rounded-2xl border border-[#E7E1D6] bg-[#FFFFFF] p-6 sm:p-8 shadow-sm">
            ...
            <ul className="mt-3 list-disc pl-5 space-y-2">
              <li>
                <strong className="text-[#111827]">Color Contrast:</strong> Body copy, headings, and
                interactive elements are tested to meet or exceed recommended contrast ratios.
              </li>
              <li>
                <strong className="text-[#111827]">Keyboard Navigation:</strong> All navigation
                links, interactive buttons, and form controls are accessible via keyboard Tab
                ordering with clear visible focus indicators.
              </li>
              <li>
                <strong className="text-[#111827]">Responsive Scaling:</strong> Layouts adapt
              ...
              <li>
                <strong className="text-[#111827]">Semantic HTML & ARIA:</strong> Landmarks (`nav`,
                `main`, `footer`, `aside`), form labels, and interactive states (`aria-expanded`,
                `aria-label`) are used to assist screen reader users.
              </li>
              <li>
                <strong className="text-[#111827]">Motion Sensitivity:</strong> Animation styles
